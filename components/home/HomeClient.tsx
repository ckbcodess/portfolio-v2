         ...
         <footer className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full pt-16 border-t border-foreground/10">
           <div className="flex flex-col gap-6 text-left">
             ...
             <div className="flex flex-col gap-2">
               <a href="mailto:rnsfordgyasi@gmail.com" className="group relative flex items-end overflow-hidden rounded-2xl px-6 py-4 text-foreground/60 hover:text-foreground hover:bg-[#efefef] dark:hover:bg-[#1d1d1d] text-base font-semibold transition-all duration-300 w-full">
                 Mail
                 <div className="absolute right-[-6px] top-[-6px] w-[52px] h-[52px] text-foreground/20 -rotate-[15deg] opacity-0 group-hover:opacity-100 translate-y-1 group-hover:translate-y-0 transition-all duration-300">
               ...
               <a href="https://www.linkedin.com/in/ransford-gyasi/" target="_blank" rel="noopener noreferrer" className="group relative flex items-end overflow-hidden rounded-2xl px-6 py-4 text-foreground/60 hover:text-foreground hover:bg-[#efefef] dark:hover:bg-[#1d1d1d] text-base font-semibold transition-all duration-300 w-full">
                 LinkedIn
                 <div className="absolute right-[-6px] top-[-6px] w-[52px] h-[52px] text-foreground/20 -rotate-[30deg] opacity-0 group-hover:opacity-100 translate-y-1 group-hover:translate-y-0 transition-all duration-300">
               ...
               <a href="https://github.com/ckbcodess" target="_blank" rel="noopener noreferrer" className="group relative flex items-end overflow-hidden rounded-2xl px-6 py-4 text-foreground/60 hover:text-foreground hover:bg-[#efefef] dark:hover:bg-[#1d1d1d] text-base font-semibold transition-all duration-300 w-full">
                 Github
                 <div className="absolute right-[-6px] top-[-6px] w-[52px] h-[52px] text-foreground/20 -rotate-[30deg] opacity-0 group-hover:opacity-100 translate-y-1 group-hover:translate-y-0 transition-all duration-300">
           ...
           <div className="flex flex-col gap-6 text-left">
             ...
             <div className="flex flex-col gap-2">
               <a href="https://x.com/ckbdidit?lang=en" target="_blank" rel="noopener noreferrer" className="group relative flex items-end overflow-hidden rounded-2xl px-6 py-4 text-foreground/60 hover:text-foreground hover:bg-[#efefef] dark:hover:bg-[#1d1d1d] text-base font-semibold transition-all duration-300 w-full">
                 X (Twitter)
                 <div className="absolute right-[-6px] top-[-6px] w-[52px] h-[52px] text-foreground/20 -rotate-[24deg] opacity-0 group-hover:opacity-100 translate-y-1 group-hover:translate-y-0 transition-all duration-300">
               ...
               <a href="https://www.instagram.com/ckb.didit/?hl=en" target="_blank" rel="noopener noreferrer" className="group relative flex items-end overflow-hidden rounded-2xl px-6 py-4 text-foreground/60 hover:text-foreground hover:bg-[#efefef] dark:hover:bg-[#1d1d1d] text-base font-semibold transition-all duration-300 w-full">
                 Instagram
                 <div className="absolute right-[-6px] top-[-6px] w-[52px] h-[52px] text-foreground/20 -rotate-[30deg] opacity-0 group-hover:opacity-100 translate-y-1 group-hover:translate-y-0 transition-all duration-300">
               ...
               <a href="https://www.artstation.com/ckbdidit" target="_blank" rel="noopener noreferrer" className="group relative flex items-end overflow-hidden rounded-2xl px-6 py-4 text-foreground/60 hover:text-foreground hover:bg-[#efefef] dark:hover:bg-[#1d1d1d] text-base font-semibold transition-all duration-300 w-full">
                 Artstation
                 <div className="absolute right-[-6px] top-[-6px] w-[52px] h-[52px] text-foreground/20 -rotate-[20deg] opacity-0 group-hover:opacity-100 translate-y-1 group-hover:translate-y-0 transition-all duration-300">
