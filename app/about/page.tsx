...
import { FlowingLineReveal } from "@/components/FlowingLineReveal";
...
const BIO_TEXT =
  "I'm Ransford \u2014 a product designer who cares about grids, aesthetics, and the small details that make interfaces feel considered. I've spent the last few years designing and shipping products end-to-end, from early concept sketches to pixel-pushed frontend code. My work sits at the intersection of clarity and craft: systems that scale, interfaces that breathe, and interactions that respect the people using them. Outside of client work I tinker with motion, type, and the occasional weekend experiment that doesn't quite know what it wants to be yet.";
        ...
        >
          <div className="self-stretch flex flex-col items-start gap-10">
            ...
            <FlowingLineReveal
              ...
              lineClassName="text-foreground text-base leading-[1.75]"
            />
