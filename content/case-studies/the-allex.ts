  ...
  sections: [
    {
      id: "the-mission",
      label: "The Mission",
      heading: "A two-pronged challenge",
      body: [
    ...
    },
    {
      id: "insight-pos",
      label: "Key Insight",
      heading: "POS systems ignore staff",
      body: [
    ...
    },
    {
      ...
      heading: "Building a brand house",
      body: [
    ...
    },
    {
      id: "solution-pos",
      label: "Solution",
      heading: "Allex POS: employee-first transactions",
      body: [
    ...
    },
    {
      id: "solution-builder",
      label: "Solution",
      heading: "Allex Builder: online in minutes",
      body: [
    ...
    },
    {
      id: "learnings",
      label: "Key Learnings",
      heading: "A unified system from the ground up",
      body: [
